...
export default function LandingPage() {
  ...
  return (
    <>
     <div className={`relative pt-14 ${buttonClicked ? 'bg-lilac' : ''}`}>
          ...
          <div className='mx-auto max-w-7xl px-6 lg:px-8'>
            <div className='mx-auto max-w-2xl text-center'>
              ...
              <div className='mt-10 flex items-center justify-center'>
                <button
                  onClick={goToPricing}
                  className={`rounded-md bg-indigo-600 px-4 py-3 text-base font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 ${buttonClicked ? 'opacity-50 cursor-not-allowed' : ''}`}
                >
                 {buttonClicked ? 'İşleniyor...' : 'Fiyatlandırmaya gidin'} 
                </button>
              </div>
            </div>
          </div>
